    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.user_type === 0 && this.config.BOT_TOKEN) {
                ...
                try {
                    this.customBot = new grammy_1.Bot(this.config.BOT_TOKEN);
                    const botInfo = yield this.customBot.api.getMe();
                ...
                console.warn(`SenderPlugin: Configuration for user_type 1 (user account) with a SESSION_STRING is present. ` +
...
exports.SenderPlugin = SenderPlugin;
